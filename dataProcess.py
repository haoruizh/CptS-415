...
if __name__ == '__main__':
    ...
    if (unformatData):
        ...
        ID_USERID_RATING = pd.merge(ID_CUSTOMERID_RATING, FINAL_UD, on = 'customer')
        ID_USERID_RATING = ID_USERID_RATING[["userID", "Id", "ratings"]]
        ID_USERID_RATING = ID_USERID_RATING.drop_duplicates(subset=["userID","Id"])
        FINAL_ID_USERID_RATING = pd.DataFrame(ID_USERID_RATING)
        ...
        FINAL_ID_USERID_RATING.to_csv("ID_USERID_RATING.csv")